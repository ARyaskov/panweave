...
//! proxy (client) attributes and the codecs of the commands a Basic Proxy
//! generates or receives — GP Notification, GP Commissioning
...
/// Client (proxy) attribute identifiers (Table 39) and shared ones
/// (Table 30).
pub mod attr {
