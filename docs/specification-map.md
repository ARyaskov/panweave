...
| 6 | Device specifications (ESI, meter, IHD, PCT, load control, range extender, smart appliance, prepayment terminal, physical device, remote comms) | `panweave-smart-energy::{devices, endpoints}`, `panweave::smart_energy_endpoints` (Table 6-2 features: planned) |
