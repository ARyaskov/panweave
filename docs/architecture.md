...
On/Off, Level Control, Color Control, Thermostat, Window Covering, Poll
Control, Alarms, Time, IAS Zone and the Basic Reset to Factory Defaults — and hands everything else to the application as
